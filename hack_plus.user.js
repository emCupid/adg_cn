    ...
    document.addEventListener("keydown", function (event) {
        ...
        if (e.keyCode == 38 && e.ctrlKey) {
            ...
            if (!OxConfigDIV) {
                    ...
                    if (hackplus_whitelist["Fuck_SSS"] != "15" && typeof(hackplus_whitelist["Fuck_SSS"]) == "number"){document.getElementById("Fuck_SSS").value = hackplus_whitelist["Fuck_SSS"]}
